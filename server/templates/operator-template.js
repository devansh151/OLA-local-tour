        ...
        <div class="mat-card example-card" style="box-shadow:0 4px 7px 0 rgba(218,220,230,.6);display:block;position:relative;padding:24px;border-radius:2px;background: #fff;color:rgba(0, 0, 0, 0.87);font-family:Roboto,'Helvetica Neue',sans-serif;border:1px solid #d3d5df;">                    
            <div class="mat-card-header">
                <div class="mat-card-header-text" style="margin: 0 8px;display:inline-block;">
                    <div class="mat-card-title" style="font-size:60px;display: flex;flex-direction: row;justify-content: flex-start;align-items: center;margin-bottom: 16px;font-weight: 500;"><div style="margin-right:15px;width:70px;height:70px;background:${colors.color7};display:inline-block;border-radius:35px;"></div><div style="/* margin-top:-25px; */">Operator</div></div>
...
module.exports = OperatorTemplate;